...
export default {
  components: {
    ...
    "tab-page-1-12": () =>
      lazyLoadView(
        import(/* webpackChunkName: "page-1-12" */ "@/views/Page-1-12.vue")
      ),
    "tab-page-2-1": () =>
      lazyLoadView(
    ...
    "tab-page-2-4": () =>
      lazyLoadView(
        import(/* webpackChunkName: "page-2-4" */ "@/views/Page-2-4.vue")
      ),
    "tab-page-2-7": () =>
      lazyLoadView(
        import(/* webpackChunkName: "page-2-7" */ "@/views/Page-2-7.vue")
      ),
    "tab-page-3-1": () =>
      lazyLoadView(
    ...
    "tab-page-4-4": () =>
      lazyLoadView(
        import(/* webpackChunkName: "page-4-4" */ "@/views/Page-4-4.vue")
      ),
    "tab-page-6-1": () =>
      lazyLoadView(
    ...
    "tab-page-6-5": () =>
      lazyLoadView(
        import(/* webpackChunkName: "page-6-5" */ "@/views/Page-6-5.vue")
      ),
    "tab-page-7-1": () =>
      lazyLoadView(
