                        ...
                        <div class="vx-row mb-2">
                            <div class="vx-col sm:w-1/3 w-full flex justify-end">
								<vs-select placeholder="검색항목" v-model="searchBy">
									<vs-select-item value="doc_nm" text="문서이름"></vs-select-item>
									<vs-select-item value="doc_desc" text="설명(제품명)"></vs-select-item>
								</vs-select>
                            </div>
				...
				<div class="flex flex-wrap">
                    <div class="w-full sm:w-1/2 px-1">
                        <div class="vx-row mb-2">
                            ...
                            <div class="vx-col sm:w-2/3 w-full">
                                <vs-input v-model="item['doc_mgmt:doc_nm']" :danger="errors['doc_mgmt:doc_nm'] != null" :danger-text="errors['doc_mgmt:doc_nm']" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full sm:w-1/2 px-1">
                        <div class="vx-row mb-2">
                            ...
                            <div class="vx-col sm:w-2/3 w-full">
								<vs-select v-model="item['doc_mgmt:type_cd']" :danger="errors['doc_mgmt:type_cd'] != null" :danger-text="errors['doc_mgmt:type_cd']">
									<vs-select-item v-for="(type, index) in types" :key="index" :value="type.comm2_cd" :text="type.comm2_nm"></vs-select-item>
								</vs-select>
                            </div>
                        </div>
				...
				<div class="flex flex-wrap">
                    <div class="w-full sm:w-1/2 px-1">
                        <div class="vx-row mb-2">
                            ...
                            <div class="vx-col sm:w-2/3 w-full">
                                <vs-input class="w-full" v-model="item['doc_mgmt:doc_desc']" :danger="errors['doc_mgmt:doc_desc'] != null" :danger-text="errors['doc_mgmt:doc_desc']" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="w-full sm:w-1/2 px-1">
                        <div class="vx-row mb-2">
                            ...
                            <div class="vx-col sm:w-2/3 w-full">
								...
								<div class="con-text-validation span-text-validation-danger vs-input--text-validation-span" v-if="errors['doc_mgmt:att'] != null">
									<span class="span-text-validation" v-text="errors['doc_mgmt:att']"></span>
								</div>
                            </div>
                        </div>
                    </div>
