  ...
  data () {
    return {
      ...
      columnDefs: [
        ...
        {
          headerName: '일자-No',
          field: 'lot_info:dt_no',
          width: 100,
        },
        {
          headerName: '연결전표 No',
          field: 'lot_info:acc_no',
          width: 100,
        },
        {
          headerName: '품목코드',
          field: 'lot_info:item_id',
          filter: true,
          width: 100,
        },
        {
          headerName: '품목명',
          field: 'lot_info:item_nm',
          width: 200,
        },
        {
          headerName: '규격',
        ...
        {
          headerName: '원산지',
          field: 'lot_info:origin',
          width: 100,
        },
        {
          headerName: '시리얼/Lot No',
          headerStyle: {textAlign: 'center'},
          field: 'lot_info:lot_no',
          width: 100,
        },
        {
          headerName: '수량',
        ...
        {
          headerName: '전표구분',
          field: 'lot_info:acc_cd',
          width: 100,
        },
        {
          headerName: '입고단가',
          field: 'lot_info:in_cost',
          width: 100,
        },
        {
          headerName: '출고단가',
          field: 'lot_info:out_cost',
          width: 100,
        },
        {
          headerName: '거래처코드',
          field: 'lot_info:comp_id',
          width: 100,
        },
        {
          headerName: '거래처명',
          field: 'lot_info:comp_nm',
          width: 100,
        },
        {
          headerName: '창고코드',
          field: 'lot_info:wh_cd',
          width: 100,
        },
        {
          headerName: '창고명',
          field: 'lot_info:wh_nm',
          width: 100,
        },
        {
          headerName: '받는창고코드',
          field: 'lot_info:in_wh_cd',
          width: 100,
        },
        {
          headerName: '받는창고명',
          field: 'lot_info:in_wh_nm',
          width: 100,
        },
        {
          headerName: '생산공정코드',
          field: 'lot_info:proc_cd',
          width: 100,
        },
        {
          headerName: '생산공정명',
          field: 'lot_info:proc_nm',
          width: 100,
        },
        {
          headerName: '품목구분',
          field: 'lot_info:item_dvn',
          width: 100,
        },
        {
          headerName: '바코드',
          field: 'lot_info:barcode',
          width: 100,
        },
        {
          headerName: '담당자ID',
          field: 'lot_info:work_id',
          width: 100,
        },
        {
          headerName: '담당자명',
          field: 'lot_info:work_nm',
          width: 100,
        },
        {
          headerName: '적요',
          field: 'lot_info:remark',
          width: 100,
        },
        {
          headerName: '안전재고',
          field: 'lot_info:safe_qty',
          width: 100,
        },
      ],
    }
