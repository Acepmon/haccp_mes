                    ...
                    <div class="w-full sm:w-1/2 px-1">
                        <div class="vx-row mb-2">
                            ...
                            <div class="vx-col sm:w-2/3 w-full">
                                <vs-input v-model="item['secu_doc_mgmt:doc_nm']" :danger="errors['secu_doc_mgmt:doc_nm'] != null" :danger-text="errors['secu_doc_mgmt:doc_nm']" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full sm:w-1/2 px-1">
                        <div class="vx-row mb-2">
                            ...
                            <div class="vx-col sm:w-2/3 w-full">
								...
								<div class="con-text-validation span-text-validation-danger vs-input--text-validation-span" v-if="errors['secu_doc_mgmt:att'] != null">
									<span class="span-text-validation" v-text="errors['secu_doc_mgmt:att']"></span>
								</div>
                            </div>
                        </div>
                    </div>
...
export default {
	...
	methods: {
		...
		save () {
			...
			api.put(this.item['secu_doc_mgmt:doc_id'], formData).then((res) => {
				this.spinner(false)
