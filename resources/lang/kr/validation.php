...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'worker:in_dt' => '입사일자',
        'worker:out_dt' => '퇴사일자',
        'worker:jumin_no' => '주민번호',
        'worker:birth_dt' => '생년월일',
        'worker:bank_nm' => '은행명',
        'worker:acct_no' => '계좌번호',
        'worker:address' => '주소',
        'worker:email' => '이메일',
        'worker:main_job' => '주요업무',
        'worker:health_chk_dt' => '보건증일자',
        'worker:haccp_doc' => 'HACCP 문서관리',
        'worker:role_cd' => '정/부구분',
        'worker:haccp_role' => 'HACCP 담당역할',
