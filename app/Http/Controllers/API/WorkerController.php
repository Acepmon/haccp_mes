...
class WorkerController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            "worker:in_dt" => "nullable|string|date_format:Ymd",
            "worker:out_dt" => "nullable|string|date_format:Ymd",
            "worker:jumin_no" => "nullable|string|max:20",
            "worker:birth_dt" => "nullable|string|date_format:Ymd",
            ...
            "worker:health_chk_dt" => "nullable|string|date_format:Ymd",
        ...
        $item = Worker::create([
            ...
            'IN_DT' => $request->input('worker:in_dt'),
            'OUT_DT' => $request->input('worker:out_dt'),
            'JUMIN_NO' => $request->input('worker:jumin_no'),
            'BIRTH_DT' => $request->input('worker:birth_dt'),
            ...
            'HEALTH_CHK_DT' => $request->input('worker:health_chk_dt'),
